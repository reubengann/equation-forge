x_{n + 1} = x_{n} + \frac{\left(a + b\right)}{2} \Delta t
...
x_{2} = x \left(t\right) + \left(v \left(t\right) \frac{\Delta t}{2} + v \left(t + \frac{\Delta t}{2}\right) \frac{\Delta t}{2}\right) + \frac{1}{2} a \left(t\right) \left(\frac{\Delta t}{2}\right)^{2} + \frac{1}{2} \left(a \left(t\right) + \frac{1}{2} \dot{a} \left(t\right) \Delta t\right) \left(\frac{\Delta t}{2}\right)^{2}
